<div>
          ...
          <div class="display-flex jc-center htKwwrf1lkuK40W2S8Ec">
    <button id="successListButton" data-modal-toggle="successListModal" class="show color-white-1 bg-primary-700 hover:bg-primary-800 _FONMPVaCsLFJJGDaaIL qHIOIw8TObHgD3VvKa5x focus:ring-primary-300 font-weight-500 rounded-lg text-sm leading-5 px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">
    Show success message
    </button>
</div>

{/* <!-- Main modal --> */}
<div id="successListModal" tabindex="-1" aria-hidden="true" class="hide M4JgixW4UN7OS2HTxbTr D3uwZnyUNJgNm_hyQDLO position-fx top-0 right-0 left-0 TnQIXm76rhSCcMn8B_oh jc-center items-center w-full ZOkM24P9ZayPKnxPVlDZ fljDC2TZ1RFTw3w5cGqo _8xmCPYX9aFuyHMd1Tch">
    <div class="QYPW4nl6nHaIbrtaXf4h padding-1-rem w-full tnci_tQZ_0ng1kTqTwHZ j34KztD3SBxL_tQWzosr _ALrM3QjY4w2nD9x3ELz">
        {/* <!-- Modal content --> */}
        <div class="QYPW4nl6nHaIbrtaXf4h padding-1-rem background-color-white-1 rounded-lg lhxYQ_2y3sYNN3W1V_3q background-color-31-41-55-1 XbA9uXviv8Jns1WOGGH8">
            <button type="button" class="color-156-163-175-1 position-ab h_B4NMrExslIH6pDuguB RuYIYC_9cfaevyC_j3SK bHPiH67mBn1_jgR3TrvW _s1HFAQPzDGxzspem6eZ _xQT_qSXfwWf6ZhwRle4 rounded-lg text-sm leading-5 padding-point-375-rem gIFtGbAiQuKVOg5QUCDU inline-flex items-center xotVay0PVtR3gElm6ql5 DTyjKhtXBNaebZa5L0l9" data-modal-toggle="successListModal">
                <svg aria-hidden="true" class="width-1-point-25-rem height-1-point-25-rem" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                <span class="rec-clipper">Close modal</span>
            </button>
            <h3 class="RSigS__XSy90w_LER1Bw VwrSTsh__so52zqMJvws font-weight-600 color-17-24-39-1 color-white-255-255-255-1">Products successfully deleted</h3>
            <p class="mb-4 font-weight-300 color-107-114-128-1 color-156-163-175-1">The following products have been successfully remove from the database:</p>
            <ul role="list" class="mb-4 kMPFLlB8Ns_cJt6_v475 text-align-left color-107-114-128-1 F4SPvvqykwH_AGlVvGqN color-156-163-175-1">
                <li class="display-flex items-center rALiclNssVZsLNt7zOhR">
                    <svg aria-hidden="true" class="dJBCIyiM9cLL9095_Hmw width-1-rem height-1-rem ew1_SdwkxzURPvHefr7i tyJFkpWRak_cMAHS46ky" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
            ...
            <button data-modal-toggle="successListModal" type="button" class="py-2 padding-left-right-point-75-rem text-sm leading-5 font-weight-500 text-center color-white-1 rounded-lg bg-primary-600 hover:bg-primary-700 _FONMPVaCsLFJJGDaaIL qHIOIw8TObHgD3VvKa5x focus:ring-primary-300 dark:focus:ring-primary-900">
                Continue
            </button>
        </div>
    </div>
...
.dark .GbuoIVQvgE1sPez3FB0O:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(31 41 55/var(--tw-bg-opacity))
}
